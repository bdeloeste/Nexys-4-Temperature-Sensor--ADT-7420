...
#set_property PACKAGE_PIN U8 [get_ports {sw}]					
...
set_property PACKAGE_PIN L3 [get_ports {sseg_temp[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[0]}]
#Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {sseg_temp[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[1]}]
#Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {sseg_temp[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[2]}]
#Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {sseg_temp[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[3]}]
#Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {sseg_temp[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[4]}]
#Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {sseg_temp[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[5]}]
#Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {sseg_temp[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg_temp[6]}]
